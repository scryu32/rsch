      ...
      try {
        ...
        const systemPrompt = {
          ...
          content: `
            ...
            수학이나 코딩을 설명할때는 자세히하고, 줄바꿈을 해서 가독성을 높히세요. HTML 관련 질문은 답할수 없습니다.
            문자를 강조할때는 <strong>강조할문자</strong>처럼 감싸서 보내고, 줄바꿈을 할때는 항상 </br>을 입력하세요.
            LaTeX를 사용하세요. 변수를 쓸때는 부조건 \\( n)\\ 같은 형식으로 사용하세요
